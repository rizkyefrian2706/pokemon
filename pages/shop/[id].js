...
export const getStaticProps = async (context) => {
    ...
    const allablty = data.abilities.map((ab) => (
        ab.ability.url
    ));
                ...
                <div className="container mx-auto px-10 bg-white m-10 ">
                    ...
                    <div>
                        ...
                        <div className="hidden" style={{
                            ...
                            {evolutions.evolves_to.map((ev) => (
                                <div className="grid grid-cols-3 justify-center text-center items-center py-3 content-center ">
                                    <div>
